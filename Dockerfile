...
# 下载并解压 sing-box
RUN wget -qO- https://github.com/SagerNet/sing-box/releases/download/v1.9.6/sing-box-1.9.6-linux-amd64.tar.gz | \
    tar -xz && \
    mv sing-box-1.9.6-linux-amd64/sing-box . && \
    rm -rf sing-box-1.9.6-linux-amd64*
